var DB_SHEETS = Object.freeze({
  ...
  BATTLE_ANSWER_LOG_QUEUE: 'BattleAnswerLogQueue',
  STAGES: 'Stages',
...
var DB_COLUMNS = Object.freeze({
  ...
  ANSWER_LOGS: ['answerLogId', 'questionId', 'playerId', 'creatorId', 'runId', 'battleId', 'floor', 'stage', 'actionType', 'selectedAnswer', 'isCorrect', 'elapsedMs', 'maxTimeMs', 'efficiency', 'finalDifficulty', 'isOtherPlayerQuestion', 'scoreDelta', 'createdAt', 'statsProcessed', 'statsProcessedAt', 'statsProcessError'],
  BATTLE_ANSWER_LOG_QUEUE: ['queueId', 'runId', 'battleId', 'playerId', 'floor', 'stage', 'answerLogCount', 'logsJson', 'createdAt', 'processed', 'processedAt', 'processError'],
  ...
  SKILLS: ['skillId', 'name', 'type', 'target', 'baseValue', 'hitCount', 'cooldown', 'conditionJson', 'difficultyBonus', 'effectJson', 'upgradeJson', 'description', 'actionPointCost', 'rarity', 'tags', 'rewardEnabled'],
...
var DB_SCHEMA = Object.freeze([
  ...
  { sheetName: DB_SHEETS.BATTLE_ANSWER_LOG_QUEUE, headers: DB_COLUMNS.BATTLE_ANSWER_LOG_QUEUE },
...
var MASTER_SETTINGS = Object.freeze([
  ...
  { key: 'requireOwnQuestionForRunStart', value: 'true', type: 'boolean', description: 'Require the player to have created a workbook question before starting a new run.' },
